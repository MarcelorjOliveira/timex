 ...
 */
public class TimesheetListControllerTest extends TimexTestCase
{
    ...
    public void testShowForm() throws Exception
    {
        ...
        applicationSecurityManager.setEmployee(mockHttpServletRequest,
                employee);
        timesheetListController = (TimesheetListController)springFactory
                .getBean("timesheetListController");
